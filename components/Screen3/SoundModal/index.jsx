...
import { Image, Modal, StyleSheet, Text, TouchableHighlight, TouchableOpacity, View, ScrollView } from 'react-native';
import { RadioButton } from 'react-native-paper';
import { Icon } from 'react-native-elements';
import { useTranslation } from 'react-i18next';

const SoundModal = ({ visible, onClose, setSelectedAudioTrack, audios }) => {
                    ...
                    <View style={styles.modalView}>
                        ...
                        <View style={{ alignItems: 'center' }}>
                            <View style={styles.btun}>
                                <Icon name='musical-note-outline' type="ionicon" size={20} color="white" />
                            </View>
                            <Text style={styles.modalText}>{t('audio')}</Text>
                        </View>
...
const styles = StyleSheet.create({
    ...
    modalView: {
        ...
        elevation: 5,
        position: 'relative',
        maxHeight: '70%', // Modal'ın maksimum yüksekliği
    },
    scrollContainer: {
        maxHeight: 200, // ScrollView'in yüksekliği (ayarlanabilir)
        marginVertical: 10,
    },
    modalText: {
        fontSize: 14,
